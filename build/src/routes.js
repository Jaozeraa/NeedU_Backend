...
var TeachersController_1 = __importDefault(require("./controllers/TeachersController"));
var SubjectsController_1 = __importDefault(require("./controllers/SubjectsController"));
var UsersController_1 = __importDefault(require("./controllers/UsersController"));
var routes = express_1.default.Router();
var upload = multer_1.default(multer_2.default);
var usersController = new UsersController_1.default();
var teachersController = new TeachersController_1.default();
var subjectsController = new SubjectsController_1.default();
...
routes.get('/teacher-auth', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, teachers, serializedTeachers;
